 ...
 *
 * Subclasses override to specify the correct scheme (wasb, wasbs, abfs, abfss).
 *
 * The Blob Storage Support is Based on Azure HDFS support in the <a
 * href="https://hadoop.apache.org/docs/current/hadoop-azure/index.html">hadoop-azure</a> module.
 *
 * The Data Lake Storage Gen 2 Support is Based on Azure HDFS support in the
 * <a
 * href="https://docs.microsoft.com/en-us/azure/storage/blobs/data-lake-storage-abfs-driver">azure data lake store</a> module.
 *
 * Documentation is available here <a href="https://hadoop.apache.org/docs/stable/hadoop-azure/abfs.html">ABFS driver documentation</a>
 */
